...
class ConfigApp(QWidget):
        ...
        try:
            ...
            for n, (key, value) in enumerate(self.config.items()):
                ...
                if isinstance(value, bool):
                    line_edit.setValidator(QRegExpValidator(QRegExp("True|False"), line_edit))
                    combobox = QComboBox()
    ...
    def save_config(self):
        r_cfg = dict(enumerate(self.config.items()))
        self.config = {}
...
def main():
    ...
    config_app.setMinimumSize(640, 480)
    config_app.setWindowTitle("Configurator")
