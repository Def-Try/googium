...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QLabel, QLineEdit, QFileDialog, QMessageBox, QGridLayout, QGroupBox
...
class ConfigApp(QWidget):
    ...
    def loadConfig(self):
        try:
            ...
            QMessageBox.warning(self, "Warning", f"File '{self.config_file}' not found.")
        except json.decoder.JSONDecodeError:
            QMessageBox.warning(self, "Warning", f"Invalid JSON file '{self.config_file}'.")
        except Exception as e:
            QMessageBox.warning(self, "Warning", f"An error occurred while loading config file '{self.config_file}': {e}")
    ...
    def save_config(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Warning", f"An error occurred while saving config file '{self.config_file}': {e}")
